...
// 2. Fetch Admin data from users table
...
<body class="bg-fixed bg-gray-50 text-gray-800 flex h-screen overflow-hidden dark:bg-slate-950 dark:text-gray-100" style="background-image: radial-gradient(circle, rgba(156, 163, 175, 0.2) 2.5px, transparent 2.5px); background-size: 40px 40px;">
            ...
            <div class="max-w-6xl mx-auto relative">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div class="lg:col-span-8 xl:col-span-9 space-y-8">
                        ...
                        <form id="admin-profile-form" onsubmit="saveProfile(event)" class="space-y-8">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1 flex items-center justify-between">
                                            First Name <i class="fa-solid fa-lock text-xs text-gray-400"></i>
                                        </label>
                                        <input type="text" value="<?php echo htmlspecialchars($user['first_name']); ?>" readonly class="w-full px-4 py-3 border border-gray-200 dark:border-slate-700/50 bg-gray-50 dark:bg-slate-800/50 rounded-xl text-gray-500 dark:text-gray-400 font-medium cursor-not-allowed focus:outline-none">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1 flex items-center justify-between">
                                            Last Name <i class="fa-solid fa-lock text-xs text-gray-400"></i>
                                        </label>
                                        <input type="text" value="<?php echo htmlspecialchars($user['last_name']); ?>" readonly class="w-full px-4 py-3 border border-gray-200 dark:border-slate-700/50 bg-gray-50 dark:bg-slate-800/50 rounded-xl text-gray-500 dark:text-gray-400 font-medium cursor-not-allowed focus:outline-none">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1 flex items-center justify-between">
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" value="<?php echo htmlspecialchars($user['phone']); ?>" required class="w-full px-4 py-3 border border-gray-300 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-imvidia/50 focus:border-imvidia dark:bg-slate-800 dark:text-white transition shadow-sm">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Login Password</label>
                                        <div class="relative">
                                            <input type="password" id="admin-password" value="SystemMaster2026!" required class="w-full px-4 py-3 border border-gray-300 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-imvidia/50 focus:border-imvidia dark:bg-slate-800 dark:text-white transition shadow-sm tracking-wider pr-12">
                            ...
                            <section class="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div class="flex items-start space-x-3 p-3 rounded-lg bg-green-50 dark:bg-green-900/10 border border-green-100 dark:border-green-800/30 transition">
                                        <i class="fa-solid fa-circle-check text-green-500 mt-0.5 text-lg"></i>
                                        <div>
                                            <p class="text-sm font-bold text-gray-900 dark:text-white">System Analytics</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Access to traffic data and statistics</p>
                                        </div>
                                    </div>

                                    <div class="flex items-start space-x-3 p-3 rounded-lg bg-gray-50 dark:bg-slate-800/30 border border-gray-100 dark:border-slate-700/30 opacity-60 grayscale transition hover:grayscale-0">
                                        <i class="fa-solid fa-circle-xmark text-red-400 mt-0.5 text-lg"></i>
                                        <div>
                                            <p class="text-sm font-bold text-gray-900 dark:text-white line-through decoration-gray-400">User Administration</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Manage customer accounts</p>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function saveProfile(event) {
            // Note: In a real implementation, you would use fetch() or form action to save to DB
